...
namespace Kata.Spec
{
    ...
    public class when_user_input_is_two_numbers
    {
        ...
        It should_return_sum_of_all = () => { _result.Should().Be(4); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_user_input_is_larger_than_1000
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_return_sum_numbers_less_than_1001 = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    }
}
