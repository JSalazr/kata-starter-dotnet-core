...
namespace Kata.Spec
{
    ...
    public class when_user_input_is_two_numbers
    {
        ...
        It should_return_the_sum_of_numbers = () => { _result.Should().Be(4); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_user_input_contains_single_character_custom_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_user_input_contains_multi_character_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_user_input_multiple_custom_delimiters
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
